...
if ($userType !== 'all') {
    $sql .= " WHERE u.db_usertype = '$userType'";
}
...
$countOwners = $conn->query("SELECT COUNT(*) as count FROM baris_userlogin WHERE db_usertype = 'owner'")->fetch_assoc()['count'];
$countAuditors = $conn->query("SELECT COUNT(*) as count FROM baris_userlogin WHERE db_usertype = 'auditor'")->fetch_assoc()['count'];
...
<head>
    ...
    <title>User Management | Station Cleaning</title>
...
<div class="flex min-h-screen">
    ...
    <div class="ml-0 md:ml-72 flex-1">
        ...
        <div class="p-6">
            ...
            <!-- Overview Section -->
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">User Overview</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div class="card p-5">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-gray-500 text-sm">Owners</p>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                            <div class='flex space-x-2'>
                                                <a href='../user-dashboard/index.php?token=" . $row['login_token'] . "' target='_blank' class='btn btn-login' title='Login as this user'>
                                                    <i class='fas fa-sign-in-alt'></i>
                                                </a>
                                                <a href='edit-user-detail.php?token=" . $row['login_token'] . "' class='btn btn-edit' title='Edit user details'>
                                                    <i class='fas fa-edit'></i>
                                                </a>
                                                <button onclick='confirmDelete(" . $row['userId'] . ", \"" . htmlspecialchars($row['db_userLoginName']) . "\")' class='btn btn-delete' title='Delete user'>
