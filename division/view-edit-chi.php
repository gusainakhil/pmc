...
<head>
    ...
    <title>CHI Management | Station Cleaning</title>
    ...
    <div class="ml-0 md:ml-72 flex-1">
        ...
        <header class="bg-white shadow-sm sticky top-0 z-10">
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl font-bold text-gray-800">CHI Management</h1>
                </div>
        ...
        <div class="p-6">
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div class="mb-4 md:mb-0">
                            ...
                            <p class="text-gray-500 text-sm mt-1">Manage CHI users and their station assignments</p>
                        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="edit-chi.php?id=<?php echo $row['userId']; ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-10 text-center text-gray-500">
                                    ...
                                    <?php if (!empty($searchTerm)): ?>
                                        <a href="view-edit-chi.php" class="text-blue-500 hover:underline mt-2 inline-block">Clear search</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <a href="create-chi.php" class="card p-5 hover:shadow-md transition-shadow">
                    <div class="flex items-center mb-4">
                        <div class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                            <i class="fas fa-user-plus text-blue-600"></i>
                        </div>
                        <h3 class="font-semibold">Add New CHI</h3>
                    </div>
                    <p class="text-sm text-gray-600 mb-4">
                        Create a new Chief Health Inspector account for station management.
                    </p>
                ...
                <a href="#" class="card p-5 hover:shadow-md transition-shadow">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="font-semibold">Export CHI List</h3>
                    </div>
                    <p class="text-sm text-gray-600 mb-4">
                        Download a spreadsheet of all Chief Health Inspectors.
                    </p>
                ...
                <a href="#" class="card p-5 hover:shadow-md transition-shadow">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="font-semibold">CHI Analytics</h3>
                    </div>
                    <p class="text-sm text-gray-600 mb-4">
                        View activity reports and performance metrics for CHIs.
                    </p>
...
<script>
    ...
    function confirmDelete(userId, userName) {
        ...
        confirmDeleteBtn.href = `delete-chi.php?userId=${userId}`;
