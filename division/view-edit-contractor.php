...
$whereClause = "WHERE db_usertype = 'contactor' AND reportType = 'PMC'";
...
// Fetch contractor users with pagination
...
<head>
    ...
    <title>Contractor Management | Station Cleaning</title>
    ...
    <div class="ml-0 md:ml-72 flex-1">
        ...
        <header class="bg-white shadow-sm sticky top-0 z-10">
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl font-bold text-gray-800">Contractor Management</h1>
                </div>
                
                <div class="flex items-center space-x-4">
                    <a href="create-contractor.php" class="flex items-center text-sm font-medium text-blue-600 hover:text-blue-800">
        ...
        <div class="p-6">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-700">Contractor Users</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div class="mb-4 md:mb-0">
                            <h2 class="text-lg font-semibold text-gray-800">Contractors</h2>
                            <p class="text-gray-500 text-sm mt-1">Manage contractor users and their station assignments</p>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <form action="" method="GET" class="flex">
                                <input 
                                    type="text" 
                                    name="search" 
                                    placeholder="Search contractor users..." 
                            ...
                            <a href="create-contractor.php" class="flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
                                <i class="fas fa-plus mr-2"></i>
                                Create Contractor
                            </a>
                        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="edit-contractor.php?id=<?php echo $row['userId']; ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-10 text-center text-gray-500">
                                    ...
                                    <p>No contractor users found<?php echo !empty($searchTerm) ? ' matching "' . htmlspecialchars($searchTerm) . '"' : ''; ?></p>
                                    <?php if (!empty($searchTerm)): ?>
                                        <a href="view-edit-contractor.php" class="text-blue-500 hover:underline mt-2 inline-block">Clear search</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <a href="create-contractor.php" class="card p-5 hover:shadow-md transition-shadow">
                    <div class="flex items-center mb-4">
                        <div class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                            <i class="fas fa-user-plus text-blue-600"></i>
                        </div>
                        <h3 class="font-semibold">Add New Contractor</h3>
                    </div>
                    <p class="text-sm text-gray-600 mb-4">
                        Create a new contractor account for station management.
                    </p>
                ...
                <a href="#" class="card p-5 hover:shadow-md transition-shadow">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="font-semibold">Export Contractor List</h3>
                    </div>
                    <p class="text-sm text-gray-600 mb-4">
                        Download a spreadsheet of all contractors.
                    </p>
                ...
                <a href="#" class="card p-5 hover:shadow-md transition-shadow"></a></a>
                    <div class="flex items-center mb-4">
                        <div class="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center mr-3">
                            <i class="fas fa-chart-pie text-purple-600"></i>
                        </div>
                        <h3 class="font-semibold">Contractor Analytics</h3>
                    </div>
                    <p class="text-sm text-gray-600 mb-4">
                        View activity reports and performance metrics for contractors.
                    </p>
            ...
            <!-- <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div class="card p-5">
                    <div class="flex justify-between mb-2">
                        <div class="text-gray-500 text-sm">Total Contractors</div>
                    ...
                    <div class="text-2xl font-bold text-gray-800">
                        <?php
                        $countTotal = $conn->query("SELECT COUNT(*) as total FROM baris_userlogin WHERE db_usertype = 'contractor' AND reportType = 'PMC'");
                ...
                <div class="card p-5">
                    <div class="flex justify-between mb-2">
                        <div class="text-gray-500 text-sm">Active Contractors</div>
                    ...
                    <div class="text-2xl font-bold text-gray-800">
                        ...
                        $countActive = $conn->query("SELECT COUNT(*) as active FROM baris_userlogin WHERE db_usertype = 'contractor' AND reportType = 'PMC' AND db_valid > '$currentDate'");
                ...
                <div class="card p-5">
                    <div class="flex justify-between mb-2">
                        <div class="text-gray-500 text-sm">Expired Contractors</div>
                    ...
                    <div class="text-2xl font-bold text-gray-800">
                        <?php
                        $countExpired = $conn->query("SELECT COUNT(*) as expired FROM baris_userlogin WHERE db_usertype = 'contractor' AND reportType = 'PMC' AND db_valid <= '$currentDate'");
                ...
                <div class="card p-5">
                    ...
                    <div class="text-2xl font-bold text-gray-800">
                        <?php
                        $countNeverLogged = $conn->query("SELECT COUNT(*) as never_logged FROM baris_userlogin WHERE db_usertype = 'contractor' AND reportType = 'PMC' AND LastLogin IS NULL");
...
<script>
    ...
    function confirmDelete(userId, userName) {
        ...
        confirmDeleteBtn.href = `delete-contractor.php?userId=${userId}`;
